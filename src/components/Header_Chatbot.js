  ...
  return (
    <View style={styles.headerWrapper}>
      ...
      <View style={styles.navBar}>
        <TouchableOpacity style={styles.navItems} onPress={() => navigation.navigate('Home')}>
        ...
        <Image source={require('../img/navbar_health_logo_focused.png')} style={styles.navbarIcons}></Image>
